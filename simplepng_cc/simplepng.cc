...
void SimplePNG::abort_(const char * s, ...)
{
	va_list args;
	va_start(args, s);
...
void SimplePNG::read_png_file(char* file_name)
{
...
void SimplePNG::write_png_file(char* file_name)
{
	/* create file */
...
void SimplePNG::process_file(void)
{
